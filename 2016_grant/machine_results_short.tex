...
between \mydef{objective} and \mydef{subjective} utilities.  Objective
...
the \mydef{selfish} preference because these agents are only concerned
...
exist.  Moreover, cooperation is induced by endowing
the \Q-learners with social utility functions.
%  to incorporate the success of others.
