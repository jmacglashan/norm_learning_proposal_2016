...
\commenta{there is actually nothing at all here about the platform! should include a paragraph about BURLAP somewhere, and should probably delete Platform from this section heading.}
