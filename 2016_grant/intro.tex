...
% zzz seems like you aren't comfortable with adding this part in. it
% zzz seems important, though, given the goal including ``stance''
% zzz (are the agents acting jointly or not?).
