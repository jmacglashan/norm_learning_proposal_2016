...
\commenta{need references. maybe ask Steve Sloman.}
...
options~\cite{George?}\commenta{Michael, can you please insert a
  reference to basic work on options here}) can be ascribed such
labels.  \commenta{Michael, can you please insert some stuff here
  about why our new IRL technology is so awesome. I think we want to
  say 1. how human-machine collaboration cannot be accomplished
  without it, and 2. it is also good for a litany of other straight
  IRL tasks, such as \ldots}
