...
\footnote{These were the words of Satya Nadella, CEO of Microsoft Corporation, on June 28, 2016.}
%\url{http://www.slate.com/articles/technology/future_tense/2016/06/microsoft_ceo_satya_nadella_humans_and_a_i_can_work_together_to_solve_society.html}
...
rejected the homo-economicus model
(e.g.,~\cite{Camerer:2003,kahnemanst82}), proposing countless
homo-sociologicus-leaning models in its stead
(e.g.,~\cite{becker1974nber, berg1995trust, charness2002understanding,
  fehr1999theory, guth1982jebo, kahneman86, rabin1993aer}).
%(e.g.,~\cite{blanco11,falk2003nature,fehr1999theory,fehr2006economics,fisman07,forsythe94,kahneman86}).
%
...
This form of reasoning is called \mydef{team
  reasoning}~\cite{bacharach1999}, and we consider it a viable
alternative to the usual notion of best-reply reasoning~\cite{cournot}
in games.
%
...
(team reasoners) or selfish (best-repliers).  While evaluating other
agents' behavior, it behooves a socially rational agent to decide upon
a strategy for itself---social or selfish?---because there is no point
in an individual agent adopting a joint plan, unilaterally.
