...
%
Note, however, that our agents continue to reason for themselves;
they just do so taking account of the collective.

We call optimal decision making, when agents can hold
%learn
...
individually optimize a \mydef{social utility function} that
...
\commenta{i'm confused; shouldn't they decide this before they employ team reasoning; and if they choose selfish, they can drop the team reasoning bit}
...
social preferences exist extrinsically; rather, they are constructs
social preferences in response to observed behaviors.  In our
conception of social rationality, agents \emph{learn\/} social
preferences through repeated play of the game.\footnote{As Shakespeare
  said, ``the play's the thing.''} They also learn whether social
behavior makes sense given the observed behavior of the other
agents---there's no point in unilaterally adopting a joint plan.
...
\commenta{i don't think this is enough. i prefer what was there before.}
