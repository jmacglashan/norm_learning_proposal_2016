...
and employ team reasoning, \mydef{socially rational} behavior.  Social
...
are socially rational), with its emphasis on \mydef{other-regarding
  preferences},\commenta{Michael, please insert references} must
