...
%\commenta{Maximum Likelihood IRL}
...
and expectation-maximization.\commenta{do these algorithms need references?}
...
an IRL algorithm towards a \mydef{shaping reward function}~\cite{},
