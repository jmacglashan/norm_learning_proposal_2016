...
\commentm{I wasn't surew what ``collaborative learning'' was, so I changed it. I hope that's ok.}
\commenta{I agree that this is not well-defined, but it PERVASIVE---possibly even in the title.
we should figure out among ourselves what it means, and then check that it is used consistently throughout.}
...
demonstrations of other agents playing collaboratively.\commenta{actually, the other agents need not be collaborating at all!}
