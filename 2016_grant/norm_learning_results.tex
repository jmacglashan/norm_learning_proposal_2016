...
\commentm{can we quantify how much faster it is than straight Q-learning?}
\commenta{it is pretty much instantaneous. none of these tests were even run for more than 5 rounds of learning. but remember, they are using team reasoning, and not solving a coordination problem---it's like they have one brain. so it is MUCH easier.}
