...
\commenta{Although any off-the-shelf IRL algorithm would be applicable here, in
these experiments, we use receding-horizon, maximum-likelihood IRL.
In future work, we of course plan to use (receding-horizon) feedback IRL instead.}
